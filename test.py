...
# Experimental Data
x_S2 = [0.000, 0.055, 0.105, 0.155, 0.205, 0.254, 0.304, 0.355, 0.405, 0.455, 0.505, 0.550, 0.605, 0.653, 0.703, 0.753, 0.804, 0.850, 0.900, 0.950, 1.000]
w_S2 = [0.00, 5.20, 12.50, 13.20, 14.45, 12.80, 10.40, 7.50, 4.30, 1.30, -2.90, -5.30, -9.00, -11.70, -14.20, -14.70, -14.00, -11.60, -10.10, -3.90, 0.00]
z_S2 = [0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0.95, 1.00]
u_S2 = [0.00, -5.50, -11.70, -12.20, -12.80, -12.65, -10.80, -8.70, -5.50, -3.20, -0.80, 2.20, 5.00, 9.00, 11.50, 13.50, 14.00, 11.50, 10.00, 3.00, 0.00]

x_S1 = [0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0.95, 1.00]
...
z_S1 = [0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0.95, 1.00]
...
ax1.plot(x_S2[::-1], w_S2, '.b')
ax1.plot(x_S1[::-1], w_S1, '.r')

fig2, ax2 = visual.plot(axis='x', cut=0.5, field='fcy2', line='y', cutlines=[0.5], scale=scale)
ax2.plot(z_S2[::-1], u_S2, '.b')
ax2.plot(z_S1[::-1], u_S1, '.r')
